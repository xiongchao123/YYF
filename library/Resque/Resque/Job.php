...
use Resque\Resque;
use Resque\Resque\Job\FactoryInterface;
use Util\Cache\Exception\InvalidArgumentException;
use Resque\Resque\Job\Status;
use Resque\Resque\Job\DontPerform;
use Resque\Resque\Job\Factory;
...
class Job
{
     ...
     * @return false|object Null when there aren't any waiting jobs, instance of Job when a job was found.
     */
